...
return STATUS:Index( 'STOP', { Duration=3.0, Color=Color3.new(0,1,0), Display='STOPPED', TICKStart=TICKStart, TICKWhile=TICKWhile, TICKAdd=TICKAdd, TICKEnd=TICKEnd } )